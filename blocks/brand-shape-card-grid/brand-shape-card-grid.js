 ...
 *
 * Variants (CSS class on the block):
 *   (none)   — default; cards are stacked on mobile, grid on desktop
 *   slider   — mobile: horizontal swipe carousel; desktop: grid
 *
...
export default async function decorate(block) {
  ...
  const isSlider = block.classList.contains('slider');

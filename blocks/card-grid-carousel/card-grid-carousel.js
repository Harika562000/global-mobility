...
function createHeader(eyebrow, titleNode) {
  ...
  header.className = 'card-grid-carousel-header';
  ...
  if (eyebrow) {
    ...
    if (eyebrowEl) {
      ...
      eyebrowWrap.className = 'card-grid-carousel-eyebrow';
...
function createCardElement(row) {
  ...
  divider.className = 'card-grid-carousel-card-divider';
  card.append(divider);

  // Image / logo area
  if (imageCell) {
    const imageWrap = document.createElement('div');
    imageWrap.className = 'card-grid-carousel-card-image';
